...
class TestSandhi(unittest.TestCase):
    ...
    def test_add_auto(self):
        test_data = [
            ...
            (["bbiòângǎ","ângbboōǎ","bbǎyūǎ","huêdāǎ","bbîbbîǎ/bbìbbîǎ","bbànbbânǎ","bbuēyâǎ/bbēyâǎ","dì cǔ ǎ dǐng gguā lě giná","toó kā cîngkì ah","gguān dì cù gguâ lāng gōng Dâiggǐ/gguān dì cù gguâ lāng gōng Dàiggǔ","dì gônghńg lâi kùn","ziā wù ciâhò bbó","zē ziǎ gāoǎ bútsî è buî/zē ziǎ gāoǎ bútsì è buî"], "Pingyim"),
    ...
    def test_add_none(self):
        test_data = [
            ...
            (["bbiôāngǎ","āngbboǒǎ","bbāhyùǎ","huēdāhǎ","bbíbbíǎ","bbânbbânǎ","bbuěyáhǎ/bběyáhǎ","dî cù ǎ dǐng gguǎ lēh giná","toó kā cīngkì ah","gguǎn dî cù gguâ lǎng gǒng Dáiggǐ/gguǎn dî cù gguâ lǎng gǒng Dáiggǔ","dî gōnghńg lâi kùn","ziā wû ciāhô bbó","zē ziāh gǎoǎ būtsí ê buî"], "Pingyim"),
