...
class TestSandhi(unittest.TestCase):
    ...
    def test_default(self):
        test_data = [
            ...
            (["kāisǐ","kǎkì","giàhué/già'hé","bbāhbāo","hīp'āo","hīthô","kāksìn","lámbbîn","bbîlái","bbíhcióh","ggiápbbû","huátgīm","háksīng"], "Pingyim"),
        ...
        for transl, system in test_data:
            ...
            checker(self, data, Converter(system=system, punctuation='none'), Converter(system=system, dialect="north", punctuation='none'))
    ...
    def test_auto(self):
        test_data = [
            ...
            (["kâisǐ","kākì","giǎhué/giǎ'hé","bbǎbāo","híp'āo","híthô","káksìn","lâmbbîn/làmbbîn","bbìlái","bbìcióh","ggiāpbbû","huātgīm","hāksīng"], "Pingyim"),
            (["kāi-sì","ka-kî","già-huĕ/già-hĕ","bhà-bau","hip-au","hit-hōr","kak-sîn","lām-bhīn/lâm-bhīn","bhî-lăi","bhî-cioh","ghiāp-bhū","huāt-gim","hāk-sing"], "Tongiong"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='auto'), Converter(system=system, dialect="north", punctuation='none', sandhi='auto'))
    ...
    def test_none(self):
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='none'), Converter(system=system, dialect="north", punctuation='none', sandhi='none'))

    def test_exc_last(self):
        test_data = [
            (["khāi-sí","kha-khì","kiá-huê/kiá-hê","bá-pau","hi̍p-au","hi̍t-hō","kha̍k-sìn","lām-bīn/làm-bīn","bì-lâi","bì-tshio̍h","giap-bū","huat-kim","hak-sing"], "Tailo"),
            (["khāi-sí","kha-khì","kiá-hôe/kiá-hê","bá-pau","hi̍p-au","hi̍t-hō","kha̍k-sìn","lām-bīn/làm-bīn","bì-lâi","bì-chhio̍h","giap-bū","hoat-kim","hak-seng"], "POJ"),
            (["ㄎㄞ˫ ㄒㄧˋ","ㄎㄚ ㄎㄧ˪","ㄍㄧㄚˋ ㄏㄨㆤˊ/ㄍㄧㄚˋ ㄏㆤˊ","ㆠㄚˋ ㄅㄠ","ㄏㄧㆴ˙ ㄠ","ㄏㄧㆵ˙ ㄏㄜ˫","ㄎㄚㆶ˙ ㄒㄧㄣ˪","ㄌㆰ˫ ㆠㄧㄣ˫/ㄌㆰ˪ ㆠㄧㄣ˫","ㆠㄧ˪ ㄌㄞˊ","ㆠㄧ˪ ㄑㄧㄜㆷ˙","ㆣㄧㄚㆴ ㆠㄨ˫","ㄏㄨㄚㆵ ㄍㄧㆬ","ㄏㄚㆶ ㄒㄧㄥ"], "Zhuyin"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='exc_last'), Converter(system=system, dialect="north", punctuation='none', sandhi='exc_last'))

    def test_incl_last(self):
        test_data = [
            ...
            (["kâisī","kākǐ","giǎhuê/giǎ'hè","bbǎbâo","híp'âo","híthò","káksǐn","lâmbbìn/làmbbìn","bbìlâi/bbìlài","bbìciò","ggiāpbbù","huātgîm","hāksîng"], "Pingyim"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='incl_last'), Converter(system=system, dialect="north", punctuation='none', sandhi='incl_last'))

    def test_add_auto(self):
        test_data = [
            (["biò-āng-á","āng-boo-á","bá-iu-á","huē-ta-á","bī-bī-á/bì-bī-á","bàn-bān-á","bue-iā-á/be-iā-á","tì tshú á tíng gua lé kiânn","thôo kha tshīng-khì--ah","guan tì tshù guā lang kong Tāi-gí/guan tì tshù guā lang kong Tài-gú","tì kōng-hn̂g lāi khùn","tsia ù tshiā-hò bô","tse tsiá kau-á pu̍t-sī è puī/tse tsiá kau-á pu̍t-sì è puī"], "Tailo"),
            (["biò-āng-á","āng-bo͘-á","bá-iu-á","hōe-ta-á","bī-bī-á/bì-bī-á","bàn-bān-á","boe-iā-á/be-iā-á","tì chhú á téng goa lé kiâⁿ","thô͘ kha chhēng-khì--ah","goan tì chhù gōa lang kong Tāi-gí/goan tì chhù gōa lang kong Tài-gú","tì kōng-hn̂g lāi khùn","chia ù chhiā-hò bô","che chiá kau-á pu̍t-sī è pūi/che chiá kau-á pu̍t-sì è pūi"], "POJ"),
            (["ㆠㄧㄜ˪ ㄤ˫ ㄚˋ","ㄤ˫ ㆠㆦ ㄚˋ","ㆠㄚˋ ㄧㄨ ㄚˋ","ㄏㄨㆤ˫ ㄉㄚ ㄚˋ","ㆠㄧ˫ ㆠㄧ˫ ㄚˋ/ㆠㄧ˪ ㆠㄧ˫ ㄚˋ","ㆠㄢ˪ ㆠㄢ˫ ㄚˋ","ㆠㄨㆤ ㄧㄚ˫ ㄚˋ/ㆠㆤ ㄧㄚ˫ ㄚˋ","ㄉㄧ˪ ㄘㄨˋ ㄚˋ ㄉㄧㄥˋ ㆣㄨㄚ ㄌㆤˋ ㄍㄧㆩˊ","ㄊㆦˊ ㄎㄚ ㄑㄧㄥ˫ ㄎㄧ˪ ㄚ","ㆣㄨㄢ ㄉㄧ˪ ㄘㄨ˪ ㆣㄨㄚ˫ ㄌㄤ ㄍㆲ ㄉㄞ˫ ㆣㄧˋ/ㆣㄨㄢ ㄉㄧ˪ ㄘㄨ˪ ㆣㄨㄚ˫ ㄌㄤ ㄍㆲ ㄉㄞ˪ ㆣㄨˋ","ㄉㄧ˪ ㄍㆲ˫ ㄏㆭˊ ㄌㄞ˫ ㄎㄨㄣ˪","ㄐㄧㄚ ㄨ˪ ㄑㄧㄚ˫ ㄏㄜ˪ ㆠㄜˊ","ㄗㆤ ㄐㄧㄚˋ ㄍㄠ ㄚˋ ㄅㄨㆵ˙ ㄒㄧ˫ ㆤ˪ ㄅㄨㄧ˫/ㄗㆤ ㄐㄧㄚˋ ㄍㄠ ㄚˋ ㄅㄨㆵ˙ ㄒㄧ˪ ㆤ˪ ㄅㄨㄧ˫"], "Zhuyin"),
            (["bio3 ang7 a2","ang7 boo1 a2","ba2 iu1 a2","hue7 ta1 a2","bi7 bi7 a2/bi3 bi7 a2","ban3 ban7 a2","bue1 ia7 a2/be1 ia7 a2","ti3 chu2 a2 ting2 gua1 le2 kiann5","thoo5 kha1 ching7 khi3 ah0","guan1 ti3 chu3 gua7 lang1 kong1 Tai7 gi2/guan1 ti3 chu3 gua7 lang1 kong1 Tai3 gu2","ti3 kong7 hng5 lai7 khun3","cia1 u3 chia7 ho3 bo5","ce1 cia2 kau1 a2 put8 si7 e3 pui7/ce1 cia2 kau1 a2 put8 si3 e3 pui7"], "TLPA"),
            (["bbiòâng'ǎ","ângbboōǎ","bbǎyūǎ","huêdāǎ","bbîbbîǎ/bbìbbîǎ","bbànbbân'ǎ","bbuēyâǎ/bbēyâǎ","dì cǔ ǎ dǐng gguā lě gniá","toó kā cîngkì ah","gguān dì cù gguâ lāng gōng Dâiggǐ/gguān dì cù gguâ lāng gōng Dàiggǔ","dì gônghńg lâi kùn","ziā wù ciâ'hò bbó","zē ziǎ gāoǎ bútsî è buî/zē ziǎ gāoǎ bútsì è buî"], "Pingyim"),
            (["bhiôr-āng-à","āng-bhor-à","bhà-iu-à","huē-da-à","bhī-bhī-à/bhî-bhī-à","bhân-bhān-à","bhue-iā-à/bhe-iā-à","dî cù à dìng ghua lè giănn","tŏr ka cīng-kî--åh","ghuan dî cû ghuā lang gong Dāi-ghì/ghuan dî cû ghuā lang gong Dâi-ghù","dî gōng-hn̆g lāi kûn","zia û ciā-hôr bhŏr","ze zià gau-à but-sī ê buī/ze zià gau-à but-sî ê buī"], "Tongiong"),
            (["biə¹¹ aŋ²² a⁵³/bio²¹ aŋ³³ a⁵¹","aŋ²² bɔ⁴⁴ a⁵³/aŋ³³ bɔ⁵⁵ a⁵¹","ba⁵³ iu⁴⁴ a⁵³/ba⁵¹ iu⁵⁵ a⁵¹","hue²² ta⁴⁴ a⁵³/hue³³ ta⁵⁵ a⁵¹","bi²² bi²² a⁵³/bi²¹ bi³³ a⁵¹","ban¹¹ ban²² a⁵³/ban²¹ ban³³ a⁵¹","bue⁴⁴ ia²² a⁵³/be⁵⁵ ia³³ a⁵¹","ti¹¹ tsʰu⁵³ a⁵³ tiɪŋ⁵³ gua⁴⁴ le⁵³ kiã²⁵/ti²¹ tsʰu⁵¹ a⁵¹ tiɪŋ⁵¹ gua⁵⁵ le⁵¹ kiã²⁴","tʰɔ²⁵ kʰa⁴⁴ tɕʰiɪŋ²² kʰi¹¹ a/tʰɔ²⁴ kʰa⁵⁵ tɕʰiɪŋ³³ kʰi²¹ a","guan⁴⁴ ti¹¹ tsʰu¹¹ gua²² laŋ⁴⁴ kɔŋ⁴⁴ Tai²² gi⁵³/guan⁵⁵ ti²¹ tsʰu²¹ gua³³ laŋ⁵⁵ kɔŋ⁵⁵ Tai²¹ gu⁵¹","ti¹¹ kɔŋ²² hŋ̍²⁵ lai²² kʰun¹¹/ti²¹ kɔŋ³³ hŋ̍²⁴ lai³³ kʰun²¹","tɕia⁴⁴ u¹¹ tɕʰia²² hə¹¹ bə²⁵/tɕia⁵⁵ u²¹ tɕʰia³³ ho²¹ bo²⁴","tse⁴⁴ tɕia⁵³ kau⁴⁴ a⁵³ put̚⁵ ɕi²² e¹¹ pui²²/tse⁵⁵ tɕia⁵¹ kau⁵⁵ a⁵¹ put̚⁴ ɕi²¹ e²¹ pui³³"], "IPA")
        ]
        for transl, system in test_data:
    ...
    def test_add_none(self):
        test_data = [
            (["biō-ang-á","ang-bóo-á","bah-iù-á","hue-tah-á","bî-bî-á","bān-bān-á","bué-ia̍h-á/bé-ia̍h-á","tī tshù á tíng guá leh kiânn","thôo kha tshing-khì--ah","guán tī tshù guā láng kóng Tâi-gí/guán tī tshù guā láng kóng Tâi-gú","tī kong-hn̂g lāi khùn","tsia ū tshia-hō bô","tse tsiah káu-á put-sî ē puī"], "Tailo"),
            (["biō-ang-á","ang-bó͘-á","bah-iù-á","hoe-tah-á","bî-bî-á","bān-bān-á","bóe-ia̍h-á/bé-ia̍h-á","tī chhù á téng góa leh kiâⁿ","thô͘ kha chheng-khì--ah","goán tī chhù gōa láng kóng Tâi-gí/goán tī chhù gōa láng kóng Tâi-gú","tī kong-hn̂g lāi khùn","chia ū chhia-hō bô","che chiah káu-á put-sî ē pūi"], "POJ"),
            (["ㆠㄧㄜ˫ ㄤ ㄚˋ","ㄤ ㆠㆦˋ ㄚˋ","ㆠㄚㆷ ㄧㄨ˪ ㄚˋ","ㄏㄨㆤ ㄉㄚㆷ ㄚˋ","ㆠㄧˊ ㆠㄧˊ ㄚˋ","ㆠㄢ˫ ㆠㄢ˫ ㄚˋ","ㆠㄨㆤˋ ㄧㄚㆷ˙ ㄚˋ/ㆠㆤˋ ㄧㄚㆷ˙ ㄚˋ","ㄉㄧ˫ ㄘㄨ˪ ㄚˋ ㄉㄧㄥˋ ㆣㄨㄚˋ ㄌㆤㆷ ㄍㄧㆩˊ","ㄊㆦˊ ㄎㄚ ㄑㄧㄥ ㄎㄧ˪ ㄚ","ㆣㄨㄢˋ ㄉㄧ˫ ㄘㄨ˪ ㆣㄨㄚ˫ ㄌㄤˋ ㄍㆲˋ ㄉㄞˊ ㆣㄧˋ/ㆣㄨㄢˋ ㄉㄧ˫ ㄘㄨ˪ ㆣㄨㄚ˫ ㄌㄤˋ ㄍㆲˋ ㄉㄞˊ ㆣㄨˋ","ㄉㄧ˫ ㄍㆲ ㄏㆭˊ ㄌㄞ˫ ㄎㄨㄣ˪","ㄐㄧㄚ ㄨ˫ ㄑㄧㄚ ㄏㄜ˫ ㆠㄜˊ","ㄗㆤ ㄐㄧㄚㆷ ㄍㄠˋ ㄚˋ ㄅㄨㆵ ㄒㄧˊ ㆤ˫ ㄅㄨㄧ˫"], "Zhuyin"),
            (["bio7 ang1 a2","ang1 boo2 a2","bah4 iu3 a2","hue1 tah4 a2","bi5 bi5 a2","ban7 ban7 a2","bue2 iah8 a2/be2 iah8 a2","ti7 chu3 a2 ting2 gua2 leh4 kiann5","thoo5 kha1 ching1 khi3 ah0","guan2 ti7 chu3 gua7 lang2 kong2 Tai5 gi2/guan2 ti7 chu3 gua7 lang2 kong2 Tai5 gu2","ti7 kong1 hng5 lai7 khun3","cia1 u7 chia1 ho7 bo5","ce1 ciah4 kau2 a2 put4 si5 e7 pui7"], "TLPA"),
            (["bbiôāng'ǎ","āngbboǒǎ","bbāhyùǎ","huēdāh'ǎ","bbíbbíǎ","bbânbbân'ǎ","bbuěyáh'ǎ/bběyáh'ǎ","dî cù ǎ dǐng gguǎ lēh gniá","toó kā cīngkì ah","gguǎn dî cù gguâ lǎng gǒng Dáiggǐ/gguǎn dî cù gguâ lǎng gǒng Dáiggǔ","dî gōnghńg lâi kùn","ziā wû ciā'hô bbó","zē ziāh gǎoǎ būtsí ê buî"], "Pingyim"),
            (["bhiōr-ang-à","ang-bhòr-à","bhāh-iû-à","hue-dāh-à","bhĭ-bhĭ-à","bhān-bhān-à","bhuè-iah-à/bhè-iah-à","dī cû à dìng ghuà lēh giănn","tŏr ka cing-kî--åh","ghuàn dī cû ghuā làng gòng Dăi-ghì/ghuàn dī cû ghuā làng gòng Dăi-ghù","dī gong-hn̆g lāi kûn","zia ū cia-hōr bhŏr","ze ziāh gàu-à būt-sĭ ē buī"], "Tongiong"),
            (["biə²² aŋ⁴⁴ a⁵³/bio³³ aŋ⁵⁵ a⁵¹","aŋ⁴⁴ bɔ⁵³ a⁵³/aŋ⁵⁵ bɔ⁵¹ a⁵¹","baʔ²¹ iu¹¹ a⁵³/baʔ³² iu²¹ a⁵¹","hue⁴⁴ taʔ²¹ a⁵³/hue⁵⁵ taʔ³² a⁵¹","bi²⁵ bi²⁵ a⁵³/bi²⁴ bi²⁴ a⁵¹","ban²² ban²² a⁵³/ban³³ ban³³ a⁵¹","bue⁵³ iaʔ⁵ a⁵³/be⁵¹ iaʔ⁴ a⁵¹","ti²² tsʰu¹¹ a⁵³ tiɪŋ⁵³ gua⁵³ leʔ²¹ kiã²⁵/ti³³ tsʰu²¹ a⁵¹ tiɪŋ⁵¹ gua⁵¹ leʔ³² kiã²⁴","tʰɔ²⁵ kʰa⁴⁴ tɕʰiɪŋ⁴⁴ kʰi¹¹ a/tʰɔ²⁴ kʰa⁵⁵ tɕʰiɪŋ⁵⁵ kʰi²¹ a","guan⁵³ ti²² tsʰu¹¹ gua²² laŋ⁵³ kɔŋ⁵³ Tai²⁵ gi⁵³/guan⁵¹ ti³³ tsʰu²¹ gua³³ laŋ⁵¹ kɔŋ⁵¹ Tai²⁴ gu⁵¹","ti²² kɔŋ⁴⁴ hŋ̍²⁵ lai²² kʰun¹¹/ti³³ kɔŋ⁵⁵ hŋ̍²⁴ lai³³ kʰun²¹","tɕia⁴⁴ u²² tɕʰia⁴⁴ hə²² bə²⁵/tɕia⁵⁵ u³³ tɕʰia⁵⁵ ho³³ bo²⁴","tse⁴⁴ tɕiaʔ²¹ kau⁵³ a⁵³ put̚²¹ ɕi²⁵ e²² pui²²/tse⁵⁵ tɕiaʔ³² kau⁵¹ a⁵¹ put̚³² ɕi²⁴ e³³ pui³³"], "IPA")
        ]
        for transl, system in test_data:
            data = list(zip(hanji_a, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='none'), Converter(system=system, dialect="north", punctuation='none', sandhi='none'))

    def test_add_exc_last(self):
        test_data = [
            (["biò-āng-á","āng-boo-á","bá-iú-á","huē-tá-á","bī-bī-á/bì-bì-á","bàn-bàn-á","bue-ià-á/be-ià-á","tì tshú a ting gua lé kiânn","thōo khā tshīng-khì--ah/thòo khā tshīng-khì--ah","guan tì tshú guà lang kong Tāi-gí/guan tì tshú guà lang kong Tài-gú","tì kōng-hn̄g lài khùn/tì kōng-hǹg lài khùn","tsiā ù tshiā-hò bô","tsē tsiá kau-a pu̍t-sī è puī/tsē tsiá kau-a pu̍t-sì è puī"], "Tailo"),
            (["biò-āng-á","āng-bo͘-á","bá-iú-á","hōe-tá-á","bī-bī-á/bì-bì-á","bàn-bàn-á","boe-ià-á/be-ià-á","tì chhú a teng goa lé kiâⁿ","thō͘ khā chhēng-khì--ah/thò͘ khā chhēng-khì--ah","goan tì chhú gòa lang kong Tāi-gí/goan tì chhú gòa lang kong Tài-gú","tì kōng-hn̄g lài khùn/tì kōng-hǹg lài khùn","chiā ù chhiā-hò bô","chē chiá kau-a pu̍t-sī è pūi/chē chiá kau-a pu̍t-sì è pūi"], "POJ"),
            (["ㆠㄧㄜ˪ ㄤ˫ ㄚˋ","ㄤ˫ ㆠㆦ ㄚˋ","ㆠㄚˋ ㄧㄨˋ ㄚˋ","ㄏㄨㆤ˫ ㄉㄚˋ ㄚˋ","ㆠㄧ˫ ㆠㄧ˫ ㄚˋ/ㆠㄧ˪ ㆠㄧ˪ ㄚˋ","ㆠㄢ˪ ㆠㄢ˪ ㄚˋ","ㆠㄨㆤ ㄧㄚ˪ ㄚˋ/ㆠㆤ ㄧㄚ˪ ㄚˋ","ㄉㄧ˪ ㄘㄨˋ ㄚ ㄉㄧㄥ ㆣㄨㄚ ㄌㆤˋ ㄍㄧㆩˊ","ㄊㆦ˫ ㄎㄚ˫ ㄑㄧㄥ˫ ㄎㄧ˪ ㄚ/ㄊㆦ˪ ㄎㄚ˫ ㄑㄧㄥ˫ ㄎㄧ˪ ㄚ","ㆣㄨㄢ ㄉㄧ˪ ㄘㄨˋ ㆣㄨㄚ˪ ㄌㄤ ㄍㆲ ㄉㄞ˫ ㆣㄧˋ/ㆣㄨㄢ ㄉㄧ˪ ㄘㄨˋ ㆣㄨㄚ˪ ㄌㄤ ㄍㆲ ㄉㄞ˪ ㆣㄨˋ","ㄉㄧ˪ ㄍㆲ˫ ㄏㆭ˫ ㄌㄞ˪ ㄎㄨㄣ˪/ㄉㄧ˪ ㄍㆲ˫ ㄏㆭ˪ ㄌㄞ˪ ㄎㄨㄣ˪","ㄐㄧㄚ˫ ㄨ˪ ㄑㄧㄚ˫ ㄏㄜ˪ ㆠㄜˊ","ㄗㆤ˫ ㄐㄧㄚˋ ㄍㄠ ㄚ ㄅㄨㆵ˙ ㄒㄧ˫ ㆤ˪ ㄅㄨㄧ˫/ㄗㆤ˫ ㄐㄧㄚˋ ㄍㄠ ㄚ ㄅㄨㆵ˙ ㄒㄧ˪ ㆤ˪ ㄅㄨㄧ˫"], "Zhuyin"),
            (["bio3 ang7 a2","ang7 boo1 a2","ba2 iu2 a2","hue7 ta2 a2","bi7 bi7 a2/bi3 bi3 a2","ban3 ban3 a2","bue1 ia3 a2/be1 ia3 a2","ti3 chu2 a1 ting1 gua1 le2 kiann5","thoo7 kha7 ching7 khi3 ah0/thoo3 kha7 ching7 khi3 ah0","guan1 ti3 chu2 gua3 lang1 kong1 Tai7 gi2/guan1 ti3 chu2 gua3 lang1 kong1 Tai3 gu2","ti3 kong7 hng7 lai3 khun3/ti3 kong7 hng3 lai3 khun3","cia7 u3 chia7 ho3 bo5","ce7 cia2 kau1 a1 put8 si7 e3 pui7/ce7 cia2 kau1 a1 put8 si3 e3 pui7"], "TLPA"),
            (["bbiòâng'ǎ","ângbboōǎ","bbǎyǔǎ","huêdǎǎ","bbîbbîǎ/bbìbbìǎ","bbànbbàn'ǎ","bbuēyàǎ/bbēyàǎ","dì cǔ ā dīng gguā lě gniá","toô kâ cîngkì ah/toò kâ cîngkì ah","gguān dì cǔ gguà lāng gōng Dâiggǐ/gguān dì cǔ gguà lāng gōng Dàiggǔ","dì gônghn̂g lài kùn/dì gônghǹg lài kùn","ziâ wù ciâ'hò bbó","zê ziǎ gāoā bútsî è buî/zê ziǎ gāoā bútsì è buî"], "Pingyim"),
            (["bhiôr-āng-à","āng-bhor-à","bhà-iù-à","huē-dà-à","bhī-bhī-à/bhî-bhî-à","bhân-bhân-à","bhue-iâ-à/bhe-iâ-à","dî cù a ding ghua lè giănn","tōr kā cīng-kî--åh/tôr kā cīng-kî--åh","ghuan dî cù ghuâ lang gong Dāi-ghì/ghuan dî cù ghuâ lang gong Dâi-ghù","dî gōng-hn̄g lâi kûn/dî gōng-hn̂g lâi kûn","ziā û ciā-hôr bhŏr","zē zià gau-a but-sī ê buī/zē zià gau-a but-sî ê buī"], "Tongiong"),
            (["biə¹¹ aŋ²² a⁵³/bio²¹ aŋ³³ a⁵¹","aŋ²² bɔ⁴⁴ a⁵³/aŋ³³ bɔ⁵⁵ a⁵¹","ba⁵³ iu⁵³ a⁵³/ba⁵¹ iu⁵¹ a⁵¹","hue²² ta⁵³ a⁵³/hue³³ ta⁵¹ a⁵¹","bi²² bi²² a⁵³/bi²¹ bi²¹ a⁵¹","ban¹¹ ban¹¹ a⁵³/ban²¹ ban²¹ a⁵¹","bue⁴⁴ ia¹¹ a⁵³/be⁵⁵ ia²¹ a⁵¹","ti¹¹ tsʰu⁵³ a⁴⁴ tiɪŋ⁴⁴ gua⁴⁴ le⁵³ kiã²⁵/ti²¹ tsʰu⁵¹ a⁵⁵ tiɪŋ⁵⁵ gua⁵⁵ le⁵¹ kiã²⁴","tʰɔ²² kʰa²² tɕʰiɪŋ²² kʰi¹¹ a/tʰɔ²¹ kʰa³³ tɕʰiɪŋ³³ kʰi²¹ a","guan⁴⁴ ti¹¹ tsʰu⁵³ gua¹¹ laŋ⁴⁴ kɔŋ⁴⁴ Tai²² gi⁵³/guan⁵⁵ ti²¹ tsʰu⁵¹ gua²¹ laŋ⁵⁵ kɔŋ⁵⁵ Tai²¹ gu⁵¹","ti¹¹ kɔŋ²² hŋ̍²² lai¹¹ kʰun¹¹/ti²¹ kɔŋ³³ hŋ̍²¹ lai²¹ kʰun²¹","tɕia²² u¹¹ tɕʰia²² hə¹¹ bə²⁵/tɕia³³ u²¹ tɕʰia³³ ho²¹ bo²⁴","tse²² tɕia⁵³ kau⁴⁴ a⁴⁴ put̚⁵ ɕi²² e¹¹ pui²²/tse³³ tɕia⁵¹ kau⁵⁵ a⁵⁵ put̚⁴ ɕi²¹ e²¹ pui³³"], "IPA")
        ]
        for transl, system in test_data:
            data = list(zip(hanji_a, transl))
    ...
    def test_add_incl_last(self):
        test_data = [
            (["biò-āng-a","āng-boo-a","bá-iú-a","huē-tá-a","bī-bī-a/bì-bì-a","bàn-bàn-a","bue-ià-a/be-ià-a","tì tshú a ting gua lé kiānn/tì tshú a ting gua lé kiànn","thōo khā tshīng-khì--ah/thòo khā tshīng-khì--ah","guan tì tshú guà lang kong Tāi-gi/guan tì tshú guà lang kong Tài-gu","tì kōng-hn̄g lài khún/tì kōng-hǹg lài khún","tsiā ù tshiā-hò bō/tsiā ù tshiā-hò bò","tsē tsiá kau-a pu̍t-sī è puì/tsē tsiá kau-a pu̍t-sì è puì"], "Tailo"),
            (["biò-āng-a","āng-bo͘-a","bá-iú-a","hōe-tá-a","bī-bī-a/bì-bì-a","bàn-bàn-a","boe-ià-a/be-ià-a","tì chhú a teng goa lé kiāⁿ/tì chhú a teng goa lé kiàⁿ","thō͘ khā chhēng-khì--ah/thò͘ khā chhēng-khì--ah","goan tì chhú gòa lang kong Tāi-gi/goan tì chhú gòa lang kong Tài-gu","tì kōng-hn̄g lài khún/tì kōng-hǹg lài khún","chiā ù chhiā-hò bō/chiā ù chhiā-hò bò","chē chiá kau-a pu̍t-sī è pùi/chē chiá kau-a pu̍t-sì è pùi"], "POJ"),
            (["ㆠㄧㄜ˪ ㄤ˫ ㄚ","ㄤ˫ ㆠㆦ ㄚ","ㆠㄚˋ ㄧㄨˋ ㄚ","ㄏㄨㆤ˫ ㄉㄚˋ ㄚ","ㆠㄧ˫ ㆠㄧ˫ ㄚ/ㆠㄧ˪ ㆠㄧ˪ ㄚ","ㆠㄢ˪ ㆠㄢ˪ ㄚ","ㆠㄨㆤ ㄧㄚ˪ ㄚ/ㆠㆤ ㄧㄚ˪ ㄚ","ㄉㄧ˪ ㄘㄨˋ ㄚ ㄉㄧㄥ ㆣㄨㄚ ㄌㆤˋ ㄍㄧㆩ˫/ㄉㄧ˪ ㄘㄨˋ ㄚ ㄉㄧㄥ ㆣㄨㄚ ㄌㆤˋ ㄍㄧㆩ˪","ㄊㆦ˫ ㄎㄚ˫ ㄑㄧㄥ˫ ㄎㄧ˪ ㄚ/ㄊㆦ˪ ㄎㄚ˫ ㄑㄧㄥ˫ ㄎㄧ˪ ㄚ","ㆣㄨㄢ ㄉㄧ˪ ㄘㄨˋ ㆣㄨㄚ˪ ㄌㄤ ㄍㆲ ㄉㄞ˫ ㆣㄧ/ㆣㄨㄢ ㄉㄧ˪ ㄘㄨˋ ㆣㄨㄚ˪ ㄌㄤ ㄍㆲ ㄉㄞ˪ ㆣㄨ","ㄉㄧ˪ ㄍㆲ˫ ㄏㆭ˫ ㄌㄞ˪ ㄎㄨㄣˋ/ㄉㄧ˪ ㄍㆲ˫ ㄏㆭ˪ ㄌㄞ˪ ㄎㄨㄣˋ","ㄐㄧㄚ˫ ㄨ˪ ㄑㄧㄚ˫ ㄏㄜ˪ ㆠㄜ˫/ㄐㄧㄚ˫ ㄨ˪ ㄑㄧㄚ˫ ㄏㄜ˪ ㆠㄜ˪","ㄗㆤ˫ ㄐㄧㄚˋ ㄍㄠ ㄚ ㄅㄨㆵ˙ ㄒㄧ˫ ㆤ˪ ㄅㄨㄧ˪/ㄗㆤ˫ ㄐㄧㄚˋ ㄍㄠ ㄚ ㄅㄨㆵ˙ ㄒㄧ˪ ㆤ˪ ㄅㄨㄧ˪"], "Zhuyin"),
            (["bio3 ang7 a1","ang7 boo1 a1","ba2 iu2 a1","hue7 ta2 a1","bi7 bi7 a1/bi3 bi3 a1","ban3 ban3 a1","bue1 ia3 a1/be1 ia3 a1","ti3 chu2 a1 ting1 gua1 le2 kiann7/ti3 chu2 a1 ting1 gua1 le2 kiann3","thoo7 kha7 ching7 khi3 ah0/thoo3 kha7 ching7 khi3 ah0","guan1 ti3 chu2 gua3 lang1 kong1 Tai7 gi1/guan1 ti3 chu2 gua3 lang1 kong1 Tai3 gu1","ti3 kong7 hng7 lai3 khun2/ti3 kong7 hng3 lai3 khun2","cia7 u3 chia7 ho3 bo7/cia7 u3 chia7 ho3 bo3","ce7 cia2 kau1 a1 put8 si7 e3 pui3/ce7 cia2 kau1 a1 put8 si3 e3 pui3"], "TLPA"),
            (["bbiòâng'ā","ângbboōā","bbǎyǔā","huêdǎā","bbîbbîā/bbìbbìā","bbànbbàn'ā","bbuēyàā/bbēyàā","dì cǔ ā dīng gguā lě gniâ/dì cǔ ā dīng gguā lě gnià","toô kâ cîngkì ah/toò kâ cîngkì ah","gguān dì cǔ gguà lāng gōng Dâiggī/gguān dì cǔ gguà lāng gōng Dàiggū","dì gônghn̂g lài kǔn/dì gônghǹg lài kǔn","ziâ wù ciâ'hò bbô/ziâ wù ciâ'hò bbò","zê ziǎ gāoā bútsî è buì/zê ziǎ gāoā bútsì è buì"], "Pingyim"),
            (["bhiôr-āng-a","āng-bhor-a","bhà-iù-a","huē-dà-a","bhī-bhī-a/bhî-bhî-a","bhân-bhân-a","bhue-iâ-a/bhe-iâ-a","dî cù a ding ghua lè giānn/dî cù a ding ghua lè giânn","tōr kā cīng-kî--åh/tôr kā cīng-kî--åh","ghuan dî cù ghuâ lang gong Dāi-ghi/ghuan dî cù ghuâ lang gong Dâi-ghu","dî gōng-hn̄g lâi kùn/dî gōng-hn̂g lâi kùn","ziā û ciā-hôr bhōr/ziā û ciā-hôr bhôr","zē zià gau-a but-sī ê buî/zē zià gau-a but-sî ê buî"], "Tongiong"),
            (["biə¹¹ aŋ²² a⁴⁴/bio²¹ aŋ³³ a⁵⁵","aŋ²² bɔ⁴⁴ a⁴⁴/aŋ³³ bɔ⁵⁵ a⁵⁵","ba⁵³ iu⁵³ a⁴⁴/ba⁵¹ iu⁵¹ a⁵⁵","hue²² ta⁵³ a⁴⁴/hue³³ ta⁵¹ a⁵⁵","bi²² bi²² a⁴⁴/bi²¹ bi²¹ a⁵⁵","ban¹¹ ban¹¹ a⁴⁴/ban²¹ ban²¹ a⁵⁵","bue⁴⁴ ia¹¹ a⁴⁴/be⁵⁵ ia²¹ a⁵⁵","ti¹¹ tsʰu⁵³ a⁴⁴ tiɪŋ⁴⁴ gua⁴⁴ le⁵³ kiã²²/ti²¹ tsʰu⁵¹ a⁵⁵ tiɪŋ⁵⁵ gua⁵⁵ le⁵¹ kiã²¹","tʰɔ²² kʰa²² tɕʰiɪŋ²² kʰi¹¹ a/tʰɔ²¹ kʰa³³ tɕʰiɪŋ³³ kʰi²¹ a","guan⁴⁴ ti¹¹ tsʰu⁵³ gua¹¹ laŋ⁴⁴ kɔŋ⁴⁴ Tai²² gi⁴⁴/guan⁵⁵ ti²¹ tsʰu⁵¹ gua²¹ laŋ⁵⁵ kɔŋ⁵⁵ Tai²¹ gu⁵⁵","ti¹¹ kɔŋ²² hŋ̍²² lai¹¹ kʰun⁵³/ti²¹ kɔŋ³³ hŋ̍²¹ lai²¹ kʰun⁵¹","tɕia²² u¹¹ tɕʰia²² hə¹¹ bə²²/tɕia³³ u²¹ tɕʰia³³ ho²¹ bo²¹","tse²² tɕia⁵³ kau⁴⁴ a⁴⁴ put̚⁵ ɕi²² e¹¹ pui¹¹/tse³³ tɕia⁵¹ kau⁵⁵ a⁵⁵ put̚⁴ ɕi²¹ e²¹ pui²¹"], "IPA")
        ]
        for transl, system in test_data:
            data = list(zip(hanji_a, transl))
    ...
    def test_sentence_auto(self):
        ...
        for transl, system in test_data:
            ...
            checker(self, data, Converter(system=system, sandhi='auto'), Converter(system=system, dialect="north", sandhi='auto'))

    def test_sentence_none(self):
        test_data = [
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='none'), Converter(system=system, dialect="north", sandhi='none'))

    def test_sentence_exc_last(self):
        test_data = [
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='exc_last'), Converter(system=system, dialect="north", sandhi='exc_last'))

    def test_sentence_incl_last(self):
        test_data = [
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='incl_last'), Converter(system=system, dialect="north", sandhi='incl_last'))