...
class TestDelimiter(unittest.TestCase):
    ...
    def test_mark(self):
        test_data = [
            ...
            (["piāogè","ǎnlnē/ǎnlnī","gàisiâozzín/gàisiâolín","bēhzzî/buēhlî","sāpsě/sāpsuě","hātkū","Hōkgiàn","lniúgniǎ","m̂bbiǎn","Béhwêzzî/Béhwêlî","ggiápsǎn","Bútzoǒ","bbákhniū","m̌bó"], "Pingyim"),
    ...
    def test_number(self):
        test_data = [
            ...
            (["phiau1 ke3","an2 ne1/an2 ni1","kai3 siau7 jin5/kai3 siau7 lin5","peh4 ji7/pueh4 li7","sap4 se2/sap4 sue2","hat4 khu1","Hok4 kian3","niu5 kiann2","m7 bian2","Peh8 ue7 ji7/Peh8 ue7 li7","giap8 san2","Put8 coo2","bak8 hiunn1","m2 po5"], "TLPA"),
            (["piao1ge3","an2lne1/an2lni1","gai3siao7zzin5/gai3siao7lin5","beh4zzi7/bueh4li7","sap4se2/sap4sue2","hat4ku1","Hok4gian3","lniu5gnia2","m7bbian2","Beh8we7zzi7/Beh8we7li7","ggiap8san2","But8zoo2","bbak8hniu1","m2bo5"], "Pingyim"),
    ...
    def test_strip(self):
        test_data = [
            ...
            (["piaoge","anlne/anlni","gaisiaozzin/gaisiaolin","behzzi/buehli","sapse/sapsue","hatku","Hokgian","lniugnia","mbbian","Behwezzi/Behweli","ggiapsan","Butzoo","bbakhniu","mbo"], "Pingyim"),
