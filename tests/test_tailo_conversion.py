...
class TestTailoConversion(unittest.TestCase):

    def test_tailo_initials(self):
    ...
    def test_tailo_vowels_and_rhymes(self):
        front = ['i','ē','înn','ênn']
    ...
    def test_tailo_syllables_additional(self):
