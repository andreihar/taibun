...
class TestTongiongConversion(unittest.TestCase):

    def test_tongiong_initials(self):
    ...
    def test_tongiong_vowels_and_rhymes(self):
        front = ['i','ē','ĭnn','ĕnn']
    ...
    def test_tongiong_syllables_additional(self):
