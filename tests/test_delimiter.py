...
class TestDelimiter(unittest.TestCase):
    ...
    def test_default(self):
        test_data = [
            ...
            (["piāogè","ǎnlnē/ǎnlnī","gàisiâozzín/gàisiâolín","ziōk lǐ gīn'ǎzzít zīnhǒ é zzítzǐ/ziōk lǐ gīn'ǎlít zīnhǒ é lítzǐ","lǎn'é ziáhbn̂g","gōngciā dídò ah"], "Pingyim"),
    ...
    def test_hyphen(self):
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', delimiter='-'), Converter(system=system, dialect="north", punctuation='none', delimiter='-'))
    ...
    def test_nospace(self):
        test_data = [
            (["phiaukè","ánne/ánni","kàisiāujîn/kàisiāulîn","tsiok lí kináji̍t tsinhó ê ji̍ttsí/tsiok lí kináli̍t tsinhó ê li̍ttsí","lánê tsia̍hpn̄g","kongtshia tîtò--ah"], "Tailo"),
            (["phiaukè","ánne/ánni","kàisiāujîn/kàisiāulîn","chiok lí kináji̍t chinhó ê ji̍tchí/chiok lí kináli̍t chinhó ê li̍tchí","lánê chia̍hpn̄g","kongchhia tîtò--ah"], "POJ"),
            (["ㄆㄧㄠㄍㆤ˪","ㄢˋㄋㆤ/ㄢˋㄋㄧ","ㄍㄞ˪ㄒㄧㄠ˫ㆢㄧㄣˊ/ㄍㄞ˪ㄒㄧㄠ˫ㄌㄧㄣˊ","ㄐㄧㆦㆶ ㄌㄧˋ ㄍㄧㄣㄚˋㆢㄧㆵ˙ ㄐㄧㄣㄏㄜˋ ㆤˊ ㆢㄧㆵ˙ㄐㄧˋ/ㄐㄧㆦㆶ ㄌㄧˋ ㄍㄧㄣㄚˋㄌㄧㆵ˙ ㄐㄧㄣㄏㄜˋ ㆤˊ ㄌㄧㆵ˙ㄐㄧˋ","ㄌㄢˋㆤˊ ㄐㄧㄚㆷ˙ㄅㆭ˫","ㄍㆲㄑㄧㄚ ㄉㄧˊㄉㄜ˪ ㄚ"], "Zhuyin"),
            (["phiau1ke3","an2ne1/an2ni1","kai3siau7jin5/kai3siau7lin5","ciok4 li2 kin1a2jit8 cin1ho2 e5 jit8ci2/ciok4 li2 kin1a2lit8 cin1ho2 e5 lit8ci2","lan2e5 ciah8png7","kong1chia1 ti5to3 ah0"], "TLPA"),
            (["piāogè","ǎnlnē/ǎnlnī","gàisiâozzín/gàisiâolín","ziōk lǐ gīn'ǎzzít zīnhǒ é zzítzǐ/ziōk lǐ gīn'ǎlít zīnhǒ é lítzǐ","lǎn'é ziáhbn̂g","gōngciā dídò ah"], "Pingyim"),
            (["piāugê","anne/anni","gàisiâurĭn/gàisiâulĭn","ziok li gīnarīt zīnhor ē rītzì/ziok li gīnalīt zīnhor ê lītzì","lanē ziâbn̄g/lanê ziâbn̄g","gōngciā dīdôr--åh/gōngciā dîdôr--åh"], "Tongiong"),
            (["pʰiau⁴⁴ke¹¹/pʰiau⁵⁵ke²¹","an⁵³nẽ⁴⁴/an⁵¹nĩ⁵⁵","kai¹¹ɕiau²²dʑin²⁵/kai²¹ɕiau³³lin²⁴","tɕiɔk̚²¹ li⁵³ kin⁴⁴a⁵³dʑit̚⁵ tɕin⁴⁴hə⁵³ e²⁵ dʑit̚⁵tɕi⁵³/tɕiɔk̚³² li⁵¹ kin⁵⁵a⁵¹lit̚⁴ tɕin⁵⁵ho⁵¹ e²⁴ lit̚⁴tɕi⁵¹","lan⁵³e²⁵ tɕiaʔ⁵pŋ̍²²/lan⁵¹e²⁴ tɕiaʔ⁴pŋ̍³³","kɔŋ⁴⁴tɕʰia⁴⁴ ti²⁵tə¹¹ a/kɔŋ⁵⁵tɕʰia⁵⁵ ti²⁴to²¹ a"], "IPA")
        ]
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
