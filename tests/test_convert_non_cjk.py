...
class TestConvertNonCJK(unittest.TestCase):
    ...
    def test_sandhi_default(self):
        test_data = [
            ...
            (["kāisǐ","kǎkì","giàhué","bbāhbāo","hīp'āo","hīthô","kāksìn","lámbbîn","bbîlái","bbíhcióh","ggiápbbû","huátgīm","háksīng"], "Pingyim"),
        ...
        for transl, system in test_data:
            ...
            checker(self, data, Converter(system=system, punctuation='none', convert_non_cjk=True), Converter(system=system, dialect="north", punctuation='none', convert_non_cjk=True))

    def test_sandhi_auto(self):
        test_data = [
            ...
            (["kâisǐ","kākì","giǎhué","bbǎbāo","híp'āo","híthô","káksìn","lâmbbîn/làmbbîn","bbìlái","bbìcióh","ggiāpbbû","huātgīm","hāksīng"], "Pingyim"),
            (["kāi-sì","ka-kî","già-huĕ","bhà-bau","hip-au","hit-hōr","kak-sîn","lām-bhīn/lâm-bhīn","bhî-lăi","bhî-cioh","ghiāp-bhū","huāt-gim","hāk-sing"], "Tongiong"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='auto', convert_non_cjk=True), Converter(system=system, dialect="north", punctuation='none', sandhi='auto', convert_non_cjk=True))

    def test_sandhi_none(self):
        test_data = [
            (["khai-sí","khá-khì","kià-huê","bah-pau","hip-au","hit-hō","khak-sìn","lâm-bīn","bī-lâi","bi̍h-tshio̍h","gia̍p-bū","hua̍t-kim","ha̍k-sing"], "Tailo"),
            (["khai-sí","khá-khì","kià-hôe","bah-pau","hip-au","hit-hō","khak-sìn","lâm-bīn","bī-lâi","bi̍h-chhio̍h","gia̍p-bū","hoa̍t-kim","ha̍k-seng"], "POJ"),
            (["ㄎㄞ ㄒㄧˋ","ㄎㄚˋ ㄎㄧ˪","ㄍㄧㄚ˪ ㄏㄨㆤˊ","ㆠㄚㆷ ㄅㄠ","ㄏㄧㆴ ㄠ","ㄏㄧㆵ ㄏㄜ˫","ㄎㄚㆶ ㄒㄧㄣ˪","ㄌㆰˊ ㆠㄧㄣ˫","ㆠㄧ˫ ㄌㄞˊ","ㆠㄧㆷ˙ ㄑㄧㄜㆷ˙","ㆣㄧㄚㆴ˙ ㆠㄨ˫","ㄏㄨㄚㆵ˙ ㄍㄧㆬ","ㄏㄚㆶ˙ ㄒㄧㄥ"], "Zhuyin"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='none', convert_non_cjk=True), Converter(system=system, dialect="north", punctuation='none', sandhi='none', convert_non_cjk=True))

    def test_sandhi_exc_last(self):
        test_data = [
            (["khāi-sí","kha-khì","kiá-huê","bá-pau","hi̍p-au","hi̍t-hō","kha̍k-sìn","lām-bīn/làm-bīn","bì-lâi","bì-tshio̍h","giap-bū","huat-kim","hak-sing"], "Tailo"),
            (["khāi-sí","kha-khì","kiá-hôe","bá-pau","hi̍p-au","hi̍t-hō","kha̍k-sìn","lām-bīn/làm-bīn","bì-lâi","bì-chhio̍h","giap-bū","hoat-kim","hak-seng"], "POJ"),
            (["ㄎㄞ˫ ㄒㄧˋ","ㄎㄚ ㄎㄧ˪","ㄍㄧㄚˋ ㄏㄨㆤˊ","ㆠㄚˋ ㄅㄠ","ㄏㄧㆴ˙ ㄠ","ㄏㄧㆵ˙ ㄏㄜ˫","ㄎㄚㆶ˙ ㄒㄧㄣ˪","ㄌㆰ˫ ㆠㄧㄣ˫/ㄌㆰ˪ ㆠㄧㄣ˫","ㆠㄧ˪ ㄌㄞˊ","ㆠㄧ˪ ㄑㄧㄜㆷ˙","ㆣㄧㄚㆴ ㆠㄨ˫","ㄏㄨㄚㆵ ㄍㄧㆬ","ㄏㄚㆶ ㄒㄧㄥ"], "Zhuyin"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='exc_last', convert_non_cjk=True), Converter(system=system, dialect="north", punctuation='none', sandhi='exc_last', convert_non_cjk=True))

    def test_sandhi_incl_last(self):
        test_data = [
            ...
            (["kâisī","kākǐ","giǎhuê/giǎhuè","bbǎbâo","híp'âo","híthò","káksǐn","lâmbbìn/làmbbìn","bbìlâi/bbìlài","bbìciò","ggiāpbbù","huātgîm","hāksîng"], "Pingyim"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_data, transl))
            checker(self, data, Converter(system=system, punctuation='none', sandhi='incl_last', convert_non_cjk=True), Converter(system=system, dialect="north", punctuation='none', sandhi='incl_last', convert_non_cjk=True))
    ...
    def test_sentence_auto(self):
        test_data = [
            ...
            (["Tǎikông bîngyū līnhō! Līn ziàbā bbuê/Tǎikông bìngyū līnhō! Līn ziàbā bbuê","Toô kâ cîngkì'ah/Toò kâ cîngkì'ah"], "Pingyim"),
        ...
        for transl, system in test_data:
            ...
            checker(self, data, Converter(system=system, sandhi='auto', convert_non_cjk=True), Converter(system=system, dialect="north", sandhi='auto', convert_non_cjk=True))
    ...
    def test_sentence_none(self):
        test_data = [
            ...
            (["Tàikōng bíngyǔ lǐnhǒ! Lǐn ziáhbǎ bbuê","Toó kā cīngkì'ah"], "Pingyim"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='none', convert_non_cjk=True), Converter(system=system, dialect="north", sandhi='none', convert_non_cjk=True))
    ...
    def test_sentence_exc_last(self):
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='exc_last', convert_non_cjk=True), Converter(system=system, dialect="north", sandhi='exc_last', convert_non_cjk=True))
    ...
    def test_sentence_incl_last(self):
        test_data = [
            ...
            (["Tǎikông bîngyū līnhō! Līn ziàbā bbuè/Tǎikông bìngyū līnhō! Līn ziàbā bbuè","Toô kâ cîngkì'ah/Toò kâ cîngkì'ah"], "Pingyim"),
        ...
        for transl, system in test_data:
            data = list(zip(hanji_sentence, transl))
            checker(self, data, Converter(system=system, sandhi='incl_last', convert_non_cjk=True), Converter(system=system, dialect="north", sandhi='incl_last', convert_non_cjk=True))