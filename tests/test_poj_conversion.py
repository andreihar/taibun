...
class TestPojConversion(unittest.TestCase):

    def test_poj_initials(self):
    ...
    def test_poj_vowels_and_rhymes(self):
        front = ['i','ē','îⁿ','êⁿ']
